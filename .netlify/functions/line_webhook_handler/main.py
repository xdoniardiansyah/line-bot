...
# Hapus: from flask import Flask, request, abort <-- Ini tidak dipakai lagi
...
# Hapus: app = Flask(__name__) <-- Ini tidak dipakai lagi
...
def handler(event, context):
    ...
    # app.logger.info("Request body: " + body) # Hapus ini, karena app.logger tidak ada di sini
